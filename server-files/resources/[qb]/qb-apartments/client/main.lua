...
RegisterNetEvent('apartments:client:SetHomeBlip', function(home)
    CreateThread(function()
        ...
        for name, _ in pairs(Apartments.Locations) do
            ...
            SetBlipColour(Apartments.Locations[name].blip, 13)
...
RegisterNetEvent("housing:orangutan:openstash", function(id)
    print("[stash] id: " .. id)
    TriggerServerEvent("inventory:server:OpenInventory", "stash", "Housing_" .. id)
...
RegisterNetEvent('apartments:client:ChangeOutfit', function()
    ...
    TriggerServerEvent("OriDN:outfitsCommand", {}) 
end)
...
exports["qb-target"]:AddCircleZone("enter", vector3(104.09985, -932.6749, 30.111581), 0.6,
    {
        name = "enter",
        debugPoly = false,
        useZ = true
